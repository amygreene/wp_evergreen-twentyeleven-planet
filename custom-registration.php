...
function show_user_form($user_name = '', $user_email = '', $errors = '') {
	...
	<?php if ( $errmsg = $errors->get_error_message('user_email') ) { ?>
		<p class="error"><?php echo $errmsg ?></p>
	<?php } ?>
	<input name="user_email" type="text" id="user_email" value="<?php  echo esc_attr($user_email) ?>" maxlength="200" /><br /><?php _e('(Your username@evergreen.edu)') ?>
	<?php
...
function signup_user($user_name = '', $user_email = '', $errors = '') {
	...
	<h2><?php printf( __( 'Using your <strong>Evergreen username and email</strong>, get your own %s account in seconds!<br />Not sure what your Evergreen login is? See <a href="http://wikis.evergreen.edu/computing/index.php/Login_Help" target="_blank">Login Help</a>' ), $current_site->site_name ) ?></h2>
	<form id="setupform" method="post" action="wp-signup.php">
